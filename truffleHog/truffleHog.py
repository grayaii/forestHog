...
def main():
    ...
    parser.add_argument("--regex", default=False, dest="do_regex", action="store_true", help="Enable high signal regex checks")
    parser.add_argument("--rules", default={}, dest="rules", help="Ignore default regexes and source from json list file")
    parser.add_argument("--entropy", default=True, dest="do_entropy", help="Enable entropy checks")
    parser.add_argument("--since_commit", default=None, dest="since_commit", help="Only scan from a given commit hash")
    parser.add_argument("--max_depth", default=1000000, dest="max_depth", help="The max commit depth to go back when searching for secrets")
    parser.add_argument("--branch", default=None, dest="branch", help="Name of the branch to be scanned")
    parser.add_argument("--repo_path", default=None, type=str, dest="repo_path", help="Path to the cloned repo. If provided, git_url will not be used")
    parser.add_argument("--cleanup", default=False, dest="cleanup", action="store_true", help="Clean up all temporary result files")
    parser.add_argument('git_url', nargs='?', default=None, type=str, help='URL for secret searching')
